    ...
    <div className="pt-24 pb-20 px-4 sm:px-6 lg:px-8 min-h-screen">
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-col sm:flex-row items-center justify-between mb-6 gap-2">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold casino-gold">WALLET</h2>
        ...
        <Card className="casino-bg-blue border-casino-gold/20 mb-6">
          <CardContent className="p-6">
            <div className="text-center">
              ...
              <div className="text-4xl sm:text-5xl font-bold casino-gold mb-4 neon-glow">
        ...
        <Card className="casino-bg-blue border-casino-gold/20 mb-6">
          <CardHeader>
            <CardTitle className="casino-gold">Manage Funds</CardTitle>
          </CardHeader>
          <CardContent>
            <Tabs defaultValue="deposit" className="w-full">
              <TabsList className="grid w-full grid-cols-2 bg-casino-navy/50">
                <TabsTrigger value="deposit" className="data-[state=active]:bg-casino-gold data-[state=active]:text-casino-navy">
                  <Plus className="mr-2" size={16} />
                  Deposit
                </TabsTrigger>
                <TabsTrigger value="withdraw" className="data-[state=active]:bg-casino-gold data-[state=active]:text-casino-navy">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-casino-navy/50 p-4 rounded-lg">
                    <div className="flex items-center space-x-2 mb-2">
                      <Bitcoin className="casino-gold" size={20} />
                  ...
                  <Button
                    ...
                    className="w-full bg-casino-gold hover:bg-casino-gold/90 text-casino-navy font-semibold"
                  >
              ...
              <TabsContent value="withdraw" className="mt-6">
                <div className="space-y-4">
                  ...
                  <Button
                    ...
                    className="w-full bg-casino-purple hover:bg-casino-purple/90 text-white font-semibold"
                  >
        ...
        <Card className="casino-bg-blue border-casino-gold/20">
          <CardHeader>
            <CardTitle className="casino-gold">Recent Transactions</CardTitle>
          </CardHeader>
          <CardContent>
